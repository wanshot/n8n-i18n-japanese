const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-CzJhPC5_.js","assets/index-CIRK3b1t.js","assets/index-BWpYwmXd.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-CsYaHvEa.js","assets/chartjs.utils-DMfnprm_.js","assets/InsightsSummary-YimPEdq0.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-C7yPnaMM.js","assets/InsightsChartFailed-CI0SbUtS.js","assets/InsightsChartFailureRate-d3ew8-Jv.js","assets/InsightsChartTimeSaved-CN5vAxjV.js","assets/InsightsChartAverageRuntime-BUnm2hGP.js","assets/InsightsTableWorkflows-bsHuFa3Z.js","assets/N8nDataTableServer-CEoFOavn.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, cS as useModel, hH as useInsightsStore, r as ref, hX as UNLICENSED_TIME_RANGE, hL as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, y as renderList, l as unref, cX as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, cW as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, hY as ElDialog, am as usePageRedirectionHelper, _ as _export_sfc, a6 as useRoute, hZ as INSIGHT_TYPES, eW as defineAsyncComponent, ab as watch, o as onMounted, aj as useDocumentTitle, m as N8nHeading, n as normalizeClass, fx as _sfc_main$4, bY as resolveDynamicComponent, az as useTelemetry, h_ as TELEMETRY_TIME_RANGE, aJ as __vitePreload } from "./index-CIRK3b1t.js";
import { I as InsightsSummary } from "./InsightsSummary-YimPEdq0.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-CzJhPC5_.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-CsYaHvEa.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-CI0SbUtS.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-d3ew8-Jv.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-CN5vAxjV.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-BUnm2hGP.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-bsHuFa3Z.js"), true ? __vite__mapDeps([13,1,2,14,6,7,15]) : void 0)
    );
    const props = __props;
