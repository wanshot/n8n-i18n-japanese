const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-CKsyzec4.js","assets/index-BcKWlmai.js","assets/index-COleXxZf.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-chRvql70.js","assets/chartjs.utils-Do38b7DI.js","assets/InsightsSummary-ByijG6Ac.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-_P3BBnep.js","assets/InsightsChartFailed-Ci3JRC6A.js","assets/InsightsChartFailureRate-D2uMUlNj.js","assets/InsightsChartTimeSaved-M5y6X89P.js","assets/InsightsChartAverageRuntime-BoVya8fR.js","assets/InsightsTableWorkflows-DkaV6N_u.js","assets/N8nDataTableServer-CneztgEK.js","assets/InsightsTableWorkflows-DJhX6bQW.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, cU as useModel, hj as useInsightsStore, r as ref, hz as UNLICENSED_TIME_RANGE, hn as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, y as renderList, l as unref, f2 as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, f1 as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, hA as ElDialog, al as usePageRedirectionHelper, _ as _export_sfc, et as defineAsyncComponent, aa as watch, o as onMounted, ai as useDocumentTitle, m as N8nHeading, n as normalizeClass, eE as _sfc_main$4, b_ as resolveDynamicComponent, ay as useTelemetry, hB as TELEMETRY_TIME_RANGE, aI as __vitePreload } from "./index-BcKWlmai.js";
import { I as InsightsSummary } from "./InsightsSummary-ByijG6Ac.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-CKsyzec4.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-chRvql70.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-Ci3JRC6A.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-D2uMUlNj.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-M5y6X89P.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-BoVya8fR.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-DkaV6N_u.js"), true ? __vite__mapDeps([13,1,2,14,6,7,15]) : void 0)
    );
    const props = __props;
    const i18n = useI18n();
