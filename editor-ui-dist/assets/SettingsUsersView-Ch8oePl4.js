import { d as defineComponent, bW as useClipboard, a as useToast, v as useSettingsStore, J as useUIStore, u as useUsersStore, eE as useSSOStore, a7 as useDocumentTitle, aa as usePageRedirectionHelper, x as computed, ad as hasPermission, o as onMounted, c as useI18n, ae as EnterpriseEditionFeature, eK as ROLE, h as resolveComponent, i as createElementBlock, g as openBlock, k as createBaseVNode, f as createCommentVNode, e as createBlock, j as createVNode, w as withCtx, l as createTextVNode, t as toDisplayString, m as unref, n as normalizeClass, F as Fragment, G as renderList, eQ as INVITE_USER_MODAL_KEY, _ as _export_sfc } from "./index-DGOSHS5X.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        unref(usersStore).usersLimitNotReached || unref(usersStore).allUsers.length > 1 ? (openBlock(), createElementBlock("div", {
          key: 2,
