const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NodeCreator-D80NpGCO.js","assets/index-C219uDw2.js","assets/index-C1XlnjOl.css","assets/NodeCreator-B1jJcOYT.css"])))=>i.map(i=>d[i]);
import { dx as useNodeCreatorStore, bw as useNodeTypesStore, x as computed, c as useI18n, T as useWorkflowsStore, hr as MANUAL_TRIGGER_NODE_TYPE, hs as CHAIN_LLM_LANGCHAIN_NODE_TYPE, bf as NodeConnectionTypes, bo as CHAT_TRIGGER_NODE_TYPE, ht as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, hu as OPEN_AI_NODE_TYPE, hv as SPLIT_IN_BATCHES_NODE_TYPE, hw as NO_OP_NODE_TYPE, hx as WEBHOOK_NODE_TYPE, hy as SCHEDULE_TRIGGER_NODE_TYPE, hz as transformNodeType, aX as useExternalHooks, a2 as useCanvasStore, hA as AI_CATEGORY_LANGUAGE_MODELS, hB as QA_CHAIN_NODE_TYPE, hC as AGENT_NODE_TYPE, hD as BASIC_CHAIN_NODE_TYPE, hE as OPEN_AI_ASSISTANT_NODE_TYPE, aG as STICKY_NODE_TYPE, hF as sortNodeCreateElements, hG as TRIGGER_NODE_CREATOR_VIEW, dy as NODE_CREATOR_OPEN_SOURCES, d as defineComponent, J as useUIStore, r as ref, c3 as useThrottleFn, o as onMounted, z as onBeforeUnmount, h as resolveComponent, i as createElementBlock, g as openBlock, f as createCommentVNode, e as createBlock, n as normalizeClass, k as createBaseVNode, j as createVNode, w as withCtx, m as unref, b_ as KeyboardShortcutTooltip, ec as defineAsyncComponent, dH as Suspense, F as Fragment, aw as __vitePreload, hH as getMidCanvasPosition, hI as DEFAULT_STICKY_WIDTH, hJ as DEFAULT_STICKY_HEIGHT, _ as _export_sfc } from "./index-C219uDw2.js";
const useActions = () => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const LazyNodeCreator = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreator-D80NpGCO.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const props = __props;
    const emit = __emit;
