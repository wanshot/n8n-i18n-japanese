const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-0qI5C5da.js","assets/index-DhBRWJnw.js","assets/index-BzamKJpD.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-B6xCgdTN.js","assets/chartjs.utils-B325E9mL.js","assets/InsightsSummary-BM_VFCZA.js","assets/InsightsSummary-DzGQpM5h.css","assets/index-Up5eFrX6.js","assets/InsightsChartFailed-BOufNVYo.js","assets/InsightsChartFailureRate-BsxBsf6n.js","assets/InsightsChartTimeSaved-BYQfIHfq.js","assets/InsightsChartAverageRuntime-BDcaLoBL.js","assets/InsightsTableWorkflows-BBDu5Uut.js","assets/InsightsTableWorkflows-DJhX6bQW.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, cX as useModel, hk as useInsightsStore, r as ref, hC as UNLICENSED_TIME_RANGE, hp as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, i as createElementBlock, F as Fragment, y as renderList, m as unref, fe as _sfc_main$3, l as createTextVNode, f as createCommentVNode, t as toDisplayString, k as createBaseVNode, fd as N8nSelect, x as computed, c as useI18n, j as createVNode, p as N8nText, q as N8nButton, hD as ElDialog, ak as usePageRedirectionHelper, _ as _export_sfc, eE as defineAsyncComponent, a9 as watch, o as onMounted, ah as useDocumentTitle, N as N8nHeading, n as normalizeClass, eP as _sfc_main$4, c2 as resolveDynamicComponent, aH as __vitePreload, ax as useTelemetry, hE as TELEMETRY_TIME_RANGE } from "./index-DhBRWJnw.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-0qI5C5da.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-B6xCgdTN.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-BOufNVYo.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-BsxBsf6n.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-BYQfIHfq.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-BDcaLoBL.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-BBDu5Uut.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
    const i18n = useI18n();
