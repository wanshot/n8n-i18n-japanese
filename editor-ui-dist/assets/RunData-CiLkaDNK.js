const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataTable-DpbKq8S-.js","assets/index-DGOSHS5X.js","assets/index-CeLskvTy.css","assets/useExecutionHelpers-UhfgqcYO.js","assets/RunDataTable-CUxj7dHx.css","assets/RunDataJson-B_hKHyRy.js","assets/FileSaver.min-Bxbh8nLE.js","assets/RunDataJson-BH9HLoGC.css","assets/RunDataParsedAiContent-VOUKBpJ_.js","assets/RunDataParsedAiContent-9EEUzCKp.css","assets/RunDataSearch-l_cB9Dof.js","assets/RunDataSearch-R6qtl0Jf.css"])))=>i.map(i=>d[i]);
import { fO as hasKey, d as defineComponent, i as createElementBlock, g as openBlock, j as createVNode, k as createBaseVNode, m as unref, p as N8nText, w as withCtx, l as createTextVNode, t as toDisplayString, c as useI18n, by as formatTokenUsageCount, bz as getDefaultExportFromCjs, r as ref, fP as MarkdownIt, x as computed, ay as h, fQ as requireVue, fR as sanitizeHtml, fS as sanitizeHtmlExports, _ as _export_sfc, T as useWorkflowsStore, o as onMounted, e9 as jsonParse, fT as base64DecodeUTF8, e as createBlock, n as normalizeClass, br as useNodeHelpers, h as resolveComponent, f as createCommentVNode, bE as withModifiers, bW as useClipboard, a as useToast, fU as useAIAssistantHelpers, bw as useNodeTypesStore, aA as useNDVStore, a1 as useRootStore, fF as useAssistantStore, J as useUIStore, fV as MAX_DISPLAY_DATA_SIZE, cQ as isCommunityPackageName, bY as resolveDirective, aI as withDirectives, fW as InlineAskAssistantButton, a$ as _sfc_main$b, F as Fragment, G as renderList, fX as NEW_ASSISTANT_SESSION_MODAL, dR as sanitizeHtml$1, aZ as N8nTooltip, a_ as N8nLink, $ as watch, bL as N8nRadioButtons, b1 as createSlots, bH as N8nIcon, a3 as useSourceControlStore, fG as useSchemaPreviewStore, U as useRoute, bJ as toRef, bp as usePinnedData, fY as useNodeType, eV as storeToRefs, fZ as TRIMMED_TASK_DATA_CONNECTIONS_KEY, bf as NodeConnectionTypes, f_ as executionDataToJson, f$ as NODE_TYPES_EXCLUDED_FROM_OUTPUT_NAME_APPEND, g0 as CORE_NODES_CATEGORY, g1 as computedAsync, g2 as parseAiContent, ce as ndvEventBus, am as useTelemetry, z as onBeforeUnmount, aR as useStorage, g3 as LOCAL_STORAGE_PIN_DATA_DISCOVERY_NDV_FLAG, g4 as dataPinningEventBus, g5 as LOCAL_STORAGE_PIN_DATA_DISCOVERY_CANVAS_FLAG, g6 as searchInObject, db as getConnectionTypes, g7 as isObject, g8 as MAX_DISPLAY_DATA_SIZE_SCHEMA_VIEW, g9 as HTML_NODE_TYPE, A as renderSlot, eg as N8nCallout, ga as DATA_PINNING_DOCS_URL, aJ as vShow, dK as Suspense, ef as defineAsyncComponent, bO as normalizeProps, bK as mergeProps, q as N8nButton, gb as N8nSelect, gc as _sfc_main$c, gd as N8nTabs, bP as guardReactiveProps, ge as _sfc_main$d, gf as JsonEditor, fs as InfoTip, gg as DATA_EDITING_DOCS_URL, gh as N8nBlockUi, aw as __vitePreload, dP as getNodeOutputs, gi as getGenericHints, gj as clearJsonKey, gk as TEST_PIN_DATA, aX as useExternalHooks, cq as isPresent, gl as isEmpty, d5 as isEqual } from "./index-DGOSHS5X.js";
import { F as FileSaver_minExports } from "./FileSaver.min-Bxbh8nLE.js";
import { u as useExecutionHelpers } from "./useExecutionHelpers-UhfgqcYO.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    const LazyRunDataTable = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataTable-DpbKq8S-.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const LazyRunDataJson = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJson-B_hKHyRy.js"), true ? __vite__mapDeps([5,1,2,6,3,7]) : void 0)
    );
    const LazyRunDataSchema = defineAsyncComponent(
      async () => await __vitePreload(() => import("./index-DGOSHS5X.js").then((n) => n.iG), true ? __vite__mapDeps([1,2]) : void 0)
    );
    ...
    const LazyRunDataAi = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataParsedAiContent-VOUKBpJ_.js"), true ? __vite__mapDeps([8,1,2,6,3,9]) : void 0)
    );
    const LazyRunDataSearch = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataSearch-l_cB9Dof.js"), true ? __vite__mapDeps([10,1,2,11]) : void 0)
    );
    const props = __props;
    const emit = __emit;
