import { d as defineComponent, a4 as useRoute, b as useRouter, af as useFoldersStore, r as ref, x as computed, c as useI18n, ap as ProjectTypes, V as VIEWS, h as resolveComponent, i as createElementBlock, g as openBlock, j as createVNode, w as withCtx, s as N8nCard, n as normalizeClass, k as createBaseVNode, f as createCommentVNode, e as createBlock, hf as ProjectCardBadge, m as unref, aF as ResourceType, fl as N8nActionToggle, bV as withModifiers, p as N8nText, l as createTextVNode, t as toDisplayString, fE as _sfc_main$3, N as N8nHeading, au as N8nBadge, aW as N8nIcon, _ as _export_sfc, a as useToast, v as useSettingsStore, S as useUIStore, u as useUsersStore, a3 as useWorkflowsStore, ae as useProjectsStore, al as getResourcePermissions, h7 as dateFormat, aT as withDirectives, aU as vShow, aw as WORKFLOW_SHARE_MODAL_KEY, ax as useTelemetry, aE as DUPLICATE_MODAL_KEY, az as useMessage, aA as MODAL_CONFIRM, aG as PROJECT_MOVE_RESOURCE_MODAL, hg as FOLDER_NAME_ILLEGAL_CHARACTERS_REGEX, hh as ILLEGAL_FOLDER_CHARACTERS, hi as FOLDER_NAME_ONLY_DOTS_REGEX, hj as FOLDER_NAME_MAX_LENGTH, ad as useSourceControlStore, aN as usePostHog, Q as useTagsStore, fU as useUsageStore, hk as useInsightsStore, ah as useDocumentTitle, R as useDebounce, ao as EnterpriseEditionFeature, hl as EASY_AI_WORKFLOW_EXPERIMENT, a9 as watch, o as onMounted, P as createEventBus, I as onBeforeUnmount, L as debounce, hm as PROJECT_ROOT, aq as useTemplateRef, bh as createSlots, Z as N8nTooltip, q as N8nButton, f2 as N8nActionBox, fb as N8nInputLabel, at as _sfc_main$5, fd as N8nSelect, F as Fragment, y as renderList, fe as _sfc_main$6, fS as N8nCheckbox, hn as Draggable, eQ as N8nLoading, ar as InlineRename, dk as N8nCallout, ho as DEFAULT_WORKFLOW_PAGE_SIZE, eG as getEasyAiWorkflowJson, fW as COMMUNITY_PLUS_ENROLLMENT_MODAL } from "./index-DhBRWJnw.js";
import { _ as _sfc_main$4 } from "./EmptySharedSectionActionBox.vue_vue_type_script_setup_true_lang-XRoIZNqO.js";
import { B as Breadcrumbs, W as WorkflowActivator, _ as __unplugin_components_0 } from "./WorkflowActivator-CKK6FUHc.js";
import { R as ResourcesListLayout } from "./ResourcesListLayout-BE4ZrTYr.js";
import { P as ProjectHeader } from "./ProjectHeader-P9tXRnhl.js";
import { T as Tags } from "./Tags-bDrpLxFy.js";
import { u as useProjectPages } from "./useProjectPages-9DQIO97y.js";
import { I as InsightsSummary } from "./InsightsSummary-BM_VFCZA.js";
import "./useWorkflowActivate-B5unPb1Z.js";
import "./TableBase-LabJ33Fr.js";
...
const __unplugin_components_6 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__cssModules", cssModules$2]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _component_FolderCard = __unplugin_components_6;
