import { d as defineComponent, i as createElementBlock, g as openBlock, D as mergeProps, k as createBaseVNode, J as renderSlot, f as createCommentVNode, n as normalizeClass, e as createBlock, t as toDisplayString, m as unref, iB as ElTag, w as withCtx, l as createTextVNode, ic as FontAwesomeIcon, gM as useI18n, j as createVNode, _ as _export_sfc, ep as reactive, o as onMounted, bf as useExternalHooks, I as onBeforeUnmount, b$ as toRefs, h as resolveComponent, dR as useNodeCreatorStore, iC as useViewStacks, gp as useNodeType, bN as useNodeTypesStore, r as ref, x as computed, iD as DEFAULT_SUBCATEGORY, iE as CREDENTIAL_ONLY_NODE_PREFIX, c as useI18n$1, iF as shouldShowCommunityNodeDetails, iG as HITL_SUBCATEGORY, c$ as isCommunityPackageName, iH as isNodePreviewKey, iI as removePreviewToken, ca as resolveDirective, bh as createSlots, aT as withDirectives, aU as vShow, O as normalizeStyle, bW as _sfc_main$p, bV as withModifiers, Z as N8nTooltip, aW as N8nIcon, d2 as COMMUNITY_NODES_INSTALLATION_DOCS_URL, eN as DRAG_EVENT_DATA_KEY, ax as useTelemetry, iJ as camelCase, iK as N8nNodeIcon, hX as WEBHOOK_NODE_TYPE, iL as getNewNodePosition, cI as NODE_SIZE, u as useUsersStore, p as N8nText, q as N8nButton, iM as useKeyboardNavigation, a3 as useWorkflowsStore, a9 as watch, c0 as normalizeProps, c1 as guardReactiveProps, c5 as onUnmounted, F as Fragment, y as renderList, eQ as N8nLoading, iN as REGULAR_NODE_CREATOR_VIEW, fm as useCommunityNodesStore, fV as i18n, dr as captureException, b as useRouter, a0 as N8nLink, V as VIEWS, e5 as CUSTOM_API_CALL_KEY, i4 as TRIGGER_NODE_CREATOR_VIEW, hU as OPEN_AI_NODE_TYPE, hT as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, iO as withMemo, dk as N8nCallout, f1 as InfoTip, iP as HTTP_REQUEST_NODE_TYPE, he as createStaticVNode, iQ as REQUEST_NODE_FORM_URL, iR as useCalloutHelpers, iS as filterAndSearchNodes, iT as getRootSearchCallouts, iU as prepareCommunityNodeDetailsViewStack, ei as getNodeIconSource, hZ as transformNodeType, iV as AINodesView, iW as AIView, iX as RegularView, iY as TriggerView, iZ as flattenCreateElements, i_ as getHumanInTheLoopActions, i$ as AI_OTHERS_NODE_CREATOR_VIEW, j0 as AI_NODE_CREATOR_VIEW, a as useToast, dh as useCredentialsStore, R as useDebounce, dG as N8nNotice, dW as Transition, j1 as AI_EVALUATION, j2 as AI_UNCATEGORIZED_CATEGORY, S as useUIStore, g6 as useAssistantStore, dT as useBuilderStore, $ as _sfc_main$q, j3 as SlideTransition, j4 as useActionsGenerator } from "./index-DhBRWJnw.js";
import { u as useActions } from "./NodeCreation-B_uEOOaK.js";
import "./NodeView-xZZ2uclJ.js";
import "./ActionDropdown-CcHWpaTB.js";
import "./useKeybindings-CG4_oE7m.js";
import "./import-curl-oOCr5Ax8.js";
import "./global-link-actions-D83d6qd4.js";
import "./useExecutionDebugging-a33v4pS9.js";
import "./useBeforeUnload-wscbbNTX.js";
      ...
      return openBlock(), createElementBlock("div", mergeProps({
        ...
        createBaseVNode("div", null, [
          createBaseVNode("div", {
            ...
            _ctx.isTrigger ? (openBlock(), createBlock(unref(FontAwesomeIcon), {
              key: 1,
              icon: "bolt",
              size: "xs",
        ...
        _ctx.showActionArrow ? (openBlock(), createElementBlock("button", {
          ...
          createVNode(unref(FontAwesomeIcon), {
            class: normalizeClass(_ctx.$style.panelArrow),
            icon: "arrow-right"
          }, null, 8, ["class"])
...
const creatorNode = "_creatorNode_12f5d_123";
const hasAction = "_hasAction_12f5d_130";
const panelIcon = "_panelIcon_12f5d_134";
const tag = "_tag_12f5d_138";
const tooltipIcon$1 = "_tooltipIcon_12f5d_161";
const panelArrow = "_panelArrow_12f5d_167";
const details = "_details_12f5d_172";
const nodeIcon$5 = "_nodeIcon_12f5d_178";
const name$1 = "_name_12f5d_183";
const description$1 = "_description_12f5d_189";
const aiIcon = "_aiIcon_12f5d_197";
const triggerIcon$1 = "_triggerIcon_12f5d_201";
const style0$m = {
  creatorNode,
  hasAction,
  panelIcon,
...
const NodeCreatorNode = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["__cssModules", cssModules$m], ["__scopeId", "data-v-4fb9df72"]]);
