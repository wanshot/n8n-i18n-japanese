const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-BeV2eSsS.js","assets/index-DGOSHS5X.js","assets/index-CeLskvTy.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-DrgwFS0W.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, aA as useNDVStore, r as ref, cP as useElementSize, x as computed, f_ as executionDataToJson, i as createElementBlock, g as openBlock, e as createBlock, j as createVNode, w as withCtx, f as createCommentVNode, m as unref, ef as defineAsyncComponent, dK as Suspense, hn as TextWithHighlights, n as normalizeClass, ho as MappingPill, gY as Draggable, aw as __vitePreload, hp as shorten, hs as getMappedExpression, ht as isString, hu as nonExistingJsonPath, aX as useExternalHooks, am as useTelemetry, _ as _export_sfc } from "./index-DGOSHS5X.js";
import { a as VueJsonPretty } from "./RunData-CiLkaDNK.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-BeV2eSsS.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
