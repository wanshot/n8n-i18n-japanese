const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-PB_Nwimc.js","assets/index-CLBZ19eQ.js","assets/index-C6LoGNAx.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-DCWNkUBa.js","assets/chartjs.utils-Bzn7IsM6.js","assets/InsightsSummary-QMZJuD_r.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-BdIhr2HO.js","assets/InsightsChartFailed-213NufEp.js","assets/InsightsChartFailureRate-BW2bCSqx.js","assets/InsightsChartTimeSaved-Bgc9cN3D.js","assets/InsightsChartAverageRuntime-CseM3ARr.js","assets/InsightsTableWorkflows-iCzlPSC9.js","assets/N8nDataTableServer-BIPeAAOO.js","assets/InsightsTableWorkflows-RGpSnp7n.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, cS as useModel, hz as useInsightsStore, r as ref, hP as UNLICENSED_TIME_RANGE, hD as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, y as renderList, l as unref, fj as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, fi as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, hQ as ElDialog, al as usePageRedirectionHelper, _ as _export_sfc, eK as defineAsyncComponent, aa as watch, o as onMounted, ai as useDocumentTitle, m as N8nHeading, n as normalizeClass, eV as _sfc_main$4, bY as resolveDynamicComponent, ay as useTelemetry, hR as TELEMETRY_TIME_RANGE, aI as __vitePreload } from "./index-CLBZ19eQ.js";
import { I as InsightsSummary } from "./InsightsSummary-QMZJuD_r.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-PB_Nwimc.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-DCWNkUBa.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-213NufEp.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-BW2bCSqx.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-Bgc9cN3D.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-CseM3ARr.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-iCzlPSC9.js"), true ? __vite__mapDeps([13,1,2,14,6,7,15]) : void 0)
    );
    const props = __props;
    const i18n = useI18n();
