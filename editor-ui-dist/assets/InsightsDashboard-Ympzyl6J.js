const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-DFDvjTFg.js","assets/index-DGOSHS5X.js","assets/index-CeLskvTy.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-BxsXxEvE.js","assets/chartjs.utils-4hjz23XG.js","assets/InsightsSummary-CQH55FVo.js","assets/InsightsSummary-DzGQpM5h.css","assets/index-fHeNAEHy.js","assets/InsightsChartFailed-BnhbfzYb.js","assets/InsightsChartFailureRate-Dd3LpoFh.js","assets/InsightsChartTimeSaved-CbidYYyO.js","assets/InsightsChartAverageRuntime-DaFZf7Ts.js","assets/InsightsTableWorkflows-DePlSnKS.js","assets/InsightsTableWorkflows-DJhX6bQW.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, cL as useModel, gV as useInsightsStore, r as ref, hf as UNLICENSED_TIME_RANGE, h1 as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, i as createElementBlock, F as Fragment, G as renderList, m as unref, gc as _sfc_main$3, l as createTextVNode, f as createCommentVNode, t as toDisplayString, k as createBaseVNode, gb as N8nSelect, x as computed, c as useI18n, j as createVNode, p as N8nText, q as N8nButton, hg as ElDialog, aa as usePageRedirectionHelper, _ as _export_sfc, ef as defineAsyncComponent, $ as watch, o as onMounted, a7 as useDocumentTitle, h as resolveComponent, n as normalizeClass, bQ as resolveDynamicComponent, aw as __vitePreload, am as useTelemetry, hh as TELEMETRY_TIME_RANGE } from "./index-DGOSHS5X.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-DFDvjTFg.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-BxsXxEvE.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-BnhbfzYb.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-Dd3LpoFh.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-CbidYYyO.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-DaFZf7Ts.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-DePlSnKS.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
    const i18n = useI18n();
