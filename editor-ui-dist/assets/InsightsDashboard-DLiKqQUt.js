const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-CceRfcSC.js","assets/index-C219uDw2.js","assets/index-C1XlnjOl.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-AstaShBZ.js","assets/chartjs.utils-BoTGeya3.js","assets/InsightsSummary-BbGDFcNk.js","assets/InsightsSummary-DzGQpM5h.css","assets/index-BcLxTJyJ.js","assets/InsightsChartFailed-OSFNE0uE.js","assets/InsightsChartFailureRate-C2Nvuqjm.js","assets/InsightsChartTimeSaved-bAOCPZvA.js","assets/InsightsChartAverageRuntime-CHcz01Ui.js","assets/InsightsTableWorkflows-Bjmv1wtW.js","assets/InsightsTableWorkflows-DJhX6bQW.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, cL as useModel, gR as useInsightsStore, r as ref, hb as UNLICENSED_TIME_RANGE, gZ as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, i as createElementBlock, F as Fragment, G as renderList, m as unref, g8 as _sfc_main$3, l as createTextVNode, f as createCommentVNode, t as toDisplayString, k as createBaseVNode, g7 as N8nSelect, x as computed, c as useI18n, j as createVNode, p as N8nText, q as N8nButton, hc as ElDialog, aa as usePageRedirectionHelper, _ as _export_sfc, ec as defineAsyncComponent, $ as watch, o as onMounted, a7 as useDocumentTitle, h as resolveComponent, n as normalizeClass, bQ as resolveDynamicComponent, aw as __vitePreload, am as useTelemetry, hd as TELEMETRY_TIME_RANGE } from "./index-C219uDw2.js";
import { I as InsightsSummary } from "./InsightsSummary-BbGDFcNk.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-CceRfcSC.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-AstaShBZ.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-OSFNE0uE.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-C2Nvuqjm.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-bAOCPZvA.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-CHcz01Ui.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-Bjmv1wtW.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
    const i18n = useI18n();
