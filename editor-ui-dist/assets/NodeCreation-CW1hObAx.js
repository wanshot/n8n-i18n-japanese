const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NodeCreator-7REdDEMD.js","assets/index-DGOSHS5X.js","assets/index-CeLskvTy.css","assets/NodeCreator-B1jJcOYT.css"])))=>i.map(i=>d[i]);
import { dy as useNodeCreatorStore, bw as useNodeTypesStore, x as computed, c as useI18n, T as useWorkflowsStore, hv as MANUAL_TRIGGER_NODE_TYPE, hw as CHAIN_LLM_LANGCHAIN_NODE_TYPE, bf as NodeConnectionTypes, bo as CHAT_TRIGGER_NODE_TYPE, hx as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, hy as OPEN_AI_NODE_TYPE, hz as SPLIT_IN_BATCHES_NODE_TYPE, hA as NO_OP_NODE_TYPE, hB as WEBHOOK_NODE_TYPE, hC as SCHEDULE_TRIGGER_NODE_TYPE, hD as transformNodeType, aX as useExternalHooks, a2 as useCanvasStore, hE as AI_CATEGORY_LANGUAGE_MODELS, hF as QA_CHAIN_NODE_TYPE, hG as AGENT_NODE_TYPE, hH as BASIC_CHAIN_NODE_TYPE, hI as OPEN_AI_ASSISTANT_NODE_TYPE, aG as STICKY_NODE_TYPE, hJ as sortNodeCreateElements, hK as TRIGGER_NODE_CREATOR_VIEW, dz as NODE_CREATOR_OPEN_SOURCES, d as defineComponent, J as useUIStore, r as ref, c4 as useThrottleFn, o as onMounted, z as onBeforeUnmount, h as resolveComponent, i as createElementBlock, g as openBlock, f as createCommentVNode, e as createBlock, n as normalizeClass, k as createBaseVNode, j as createVNode, w as withCtx, m as unref, b$ as KeyboardShortcutTooltip, ef as defineAsyncComponent, dK as Suspense, F as Fragment, aw as __vitePreload, hL as getMidCanvasPosition, hM as DEFAULT_STICKY_WIDTH, hN as DEFAULT_STICKY_HEIGHT, _ as _export_sfc } from "./index-DGOSHS5X.js";
const useActions = () => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const LazyNodeCreator = defineAsyncComponent(
      async () => await __vitePreload(() => import("./NodeCreator-7REdDEMD.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const props = __props;
    const emit = __emit;
