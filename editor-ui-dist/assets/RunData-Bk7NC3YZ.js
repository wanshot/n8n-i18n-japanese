const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataTable-D4-RkmXT.js","assets/index-CFOGSwPZ.js","assets/index-COleXxZf.css","assets/useExecutionHelpers-CIZJ2IcZ.js","assets/RunDataTable-CTBtmQIs.css","assets/RunDataJson-BNBJcI4P.js","assets/FileSaver.min-04AzZW4e.js","assets/useKeybindings-BuBiZauw.js","assets/useKeybindings-BUK7Ngh6.css","assets/RunDataJson-BH9HLoGC.css","assets/RunDataParsedAiContent-DKiIej0D.js","assets/RunDataParsedAiContent-wfIiKsq7.css","assets/RunDataSearch-BYjxHFBe.js","assets/RunDataSearch-2eEalFoi.css"])))=>i.map(i=>d[i]);
import { g5 as hasKey, d as defineComponent, h as createElementBlock, g as openBlock, i as createVNode, j as createBaseVNode, l as unref, p as N8nText, w as withCtx, k as createTextVNode, t as toDisplayString, c as useI18n, bI as formatTokenUsageCount, bJ as getDefaultExportFromCjs, r as ref, g6 as MarkdownIt, x as computed, aK as h, g7 as requireVue, g8 as sanitizeHtml, g9 as sanitizeHtmlExports, _ as _export_sfc, a4 as useWorkflowsStore, o as onMounted, ek as jsonParse, ga as base64DecodeUTF8, e as createBlock, n as normalizeClass, bB as useNodeHelpers, f as createCommentVNode, q as N8nButton, bO as withModifiers, c2 as useClipboard, a as useToast, gb as useAIAssistantHelpers, bG as useNodeTypesStore, aM as useNDVStore, ac as useRootStore, fX as useAssistantStore, T as useUIStore, gc as MAX_DISPLAY_DATA_SIZE, cY as isCommunityPackageName, c4 as resolveDirective, aU as withDirectives, gd as InlineAskAssistantButton, $ as N8nTooltip, a0 as _sfc_main$b, N as N8nIcon, F as Fragment, y as renderList, ge as NEW_ASSISTANT_SESSION_MODAL, dX as sanitizeHtml$1, a1 as N8nLink, aa as watch, H as N8nRadioButtons, bh as createSlots, O as resolveComponent, e_ as N8nSelect, e$ as _sfc_main$c, ae as useSourceControlStore, fY as useSchemaPreviewStore, aO as usePostHog, a5 as useRoute, bT as toRef, bz as usePinnedData, gf as useNodeType, fe as storeToRefs, gg as TRIMMED_TASK_DATA_CONNECTIONS_KEY, bo as NodeConnectionTypes, gh as executionDataToJson, gi as NODE_TYPES_EXCLUDED_FROM_OUTPUT_NAME_APPEND, gj as CORE_NODES_CATEGORY, dk as NDV_UI_OVERHAUL_EXPERIMENT, gk as computedAsync, gl as parseAiContent, cm as ndvEventBus, ay as useTelemetry, I as onBeforeUnmount, b6 as useStorage, gm as LOCAL_STORAGE_PIN_DATA_DISCOVERY_NDV_FLAG, gn as dataPinningEventBus, go as LOCAL_STORAGE_PIN_DATA_DISCOVERY_CANVAS_FLAG, gp as searchInObject, gq as getConnectionTypes, gr as RUN_DATA_DEFAULT_PAGE_SIZE, gs as isObject, gt as MAX_DISPLAY_DATA_SIZE_SCHEMA_VIEW, gu as HTML_NODE_TYPE, J as renderSlot, dg as N8nCallout, gv as DATA_PINNING_DOCS_URL, aV as vShow, dQ as Suspense, eq as defineAsyncComponent, bW as normalizeProps, D as mergeProps, d0 as N8nTabs, bX as guardReactiveProps, eB as _sfc_main$d, gw as JsonEditor, eO as InfoTip, gx as DATA_EDITING_DOCS_URL, aI as __vitePreload, dV as getNodeOutputs, gy as getGenericHints, gz as clearJsonKey, gA as TEST_PIN_DATA, bf as useExternalHooks, cy as isPresent, gB as isEmpty, dL as isEqual } from "./index-CFOGSwPZ.js";
import { F as FileSaver_minExports } from "./FileSaver.min-04AzZW4e.js";
import { N as N8nBlockUi } from "./useKeybindings-BuBiZauw.js";
import { u as useExecutionHelpers } from "./useExecutionHelpers-CIZJ2IcZ.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    const LazyRunDataTable = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataTable-D4-RkmXT.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const LazyRunDataJson = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJson-BNBJcI4P.js"), true ? __vite__mapDeps([5,1,2,6,7,8,3,9]) : void 0)
    );
    const LazyRunDataSchema = defineAsyncComponent(
      async () => await __vitePreload(() => import("./index-CFOGSwPZ.js").then((n) => n.i_), true ? __vite__mapDeps([1,2]) : void 0)
    );
    ...
    const LazyRunDataAi = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataParsedAiContent-DKiIej0D.js"), true ? __vite__mapDeps([10,1,2,6,7,8,3,11]) : void 0)
    );
    const LazyRunDataSearch = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataSearch-BYjxHFBe.js"), true ? __vite__mapDeps([12,1,2,13]) : void 0)
    );
    const props = __props;
    const emit = __emit;
