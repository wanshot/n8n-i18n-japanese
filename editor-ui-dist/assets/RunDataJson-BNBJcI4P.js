const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-n_35oUEP.js","assets/index-CFOGSwPZ.js","assets/index-COleXxZf.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-B2jW3_UG.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, aM as useNDVStore, r as ref, cW as useElementSize, x as computed, gh as executionDataToJson, h as createElementBlock, g as openBlock, e as createBlock, i as createVNode, w as withCtx, f as createCommentVNode, l as unref, eq as defineAsyncComponent, dQ as Suspense, hF as TextWithHighlights, n as normalizeClass, hG as MappingPill, hi as Draggable, aI as __vitePreload, hH as shorten, hJ as getMappedExpression, bf as useExternalHooks, ay as useTelemetry, hK as isString, hL as nonExistingJsonPath, _ as _export_sfc } from "./index-CFOGSwPZ.js";
import { a as VueJsonPretty } from "./RunData-Bk7NC3YZ.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-n_35oUEP.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
