...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    const LazyRunDataTable = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataTable-BRZ8HNxA.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const LazyRunDataJson = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJson-D2tVFb3l.js"), true ? __vite__mapDeps([5,1,2,6,3,7]) : void 0)
    );
    const LazyRunDataSchema = defineAsyncComponent(
      async () => await __vitePreload(() => import("./index-CIRK3b1t.js").then((n) => n.jr), true ? __vite__mapDeps([1,2]) : void 0)
    );
    ...
    const LazyRunDataAi = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataParsedAiContent-DqD1nz_2.js").then((n) => n.d), true ? __vite__mapDeps([8,1,2,9,10]) : void 0)
    );
    const LazyRunDataSearch = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataSearch-IhwgbRN5.js"), true ? __vite__mapDeps([11,1,2,12]) : void 0)
    );
    const props = __props;
    const emit = __emit;
