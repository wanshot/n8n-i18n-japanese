const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-Bf7sqFtq.js","assets/index-CFOGSwPZ.js","assets/index-COleXxZf.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-B7TsYztg.js","assets/chartjs.utils-BR5L1SjZ.js","assets/InsightsSummary--mrYsb_5.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-D9T5Hx99.js","assets/InsightsChartFailed-Wr3s-3zu.js","assets/InsightsChartFailureRate-BuXGXTQl.js","assets/InsightsChartTimeSaved-D3A2f1j_.js","assets/InsightsChartAverageRuntime-DvG3vjHb.js","assets/InsightsTableWorkflows-DBKSXyf0.js","assets/N8nDataTableServer-BJOhuA_3.js","assets/InsightsTableWorkflows-DJhX6bQW.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, cS as useModel, hg as useInsightsStore, r as ref, hw as UNLICENSED_TIME_RANGE, hk as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, y as renderList, l as unref, e$ as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, e_ as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, hx as ElDialog, al as usePageRedirectionHelper, _ as _export_sfc, eq as defineAsyncComponent, aa as watch, o as onMounted, ai as useDocumentTitle, m as N8nHeading, n as normalizeClass, eB as _sfc_main$4, bY as resolveDynamicComponent, ay as useTelemetry, hy as TELEMETRY_TIME_RANGE, aI as __vitePreload } from "./index-CFOGSwPZ.js";
import { I as InsightsSummary } from "./InsightsSummary--mrYsb_5.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-Bf7sqFtq.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-B7TsYztg.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-Wr3s-3zu.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-BuXGXTQl.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-D3A2f1j_.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-DvG3vjHb.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-DBKSXyf0.js"), true ? __vite__mapDeps([13,1,2,14,6,7,15]) : void 0)
    );
    const props = __props;
    const i18n = useI18n();
