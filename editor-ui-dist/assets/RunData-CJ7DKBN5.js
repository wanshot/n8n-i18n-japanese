...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    const LazyRunDataTable = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataTable-DoAipYXy.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const LazyRunDataJson = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJson-Cn1s9kQ2.js"), true ? __vite__mapDeps([5,1,2,6,7,8,3,9]) : void 0)
    );
    const LazyRunDataSchema = defineAsyncComponent(
      async () => await __vitePreload(() => import("./index-BcKWlmai.js").then((n) => n.j1), true ? __vite__mapDeps([1,2]) : void 0)
    );
    ...
    const LazyRunDataAi = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataParsedAiContent-Bh78pFMy.js"), true ? __vite__mapDeps([10,1,2,6,7,8,3,11]) : void 0)
    );
    const LazyRunDataSearch = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataSearch-D0EICT4N.js"), true ? __vite__mapDeps([12,1,2,13]) : void 0)
    );
    const props = __props;
    const emit = __emit;
