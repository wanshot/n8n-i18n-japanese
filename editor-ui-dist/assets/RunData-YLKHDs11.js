const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataTable-DNGQZDU6.js","assets/index-C219uDw2.js","assets/index-C1XlnjOl.css","assets/useExecutionHelpers-BP0_q8Ec.js","assets/RunDataTable-CUxj7dHx.css","assets/RunDataJson-CKELOUee.js","assets/FileSaver.min-B7bYplvz.js","assets/RunDataJson-BH9HLoGC.css","assets/RunDataParsedAiContent-DS2qA7mb.js","assets/RunDataParsedAiContent-9EEUzCKp.css","assets/RunDataSearch-J3D6xD4K.js","assets/RunDataSearch-R6qtl0Jf.css"])))=>i.map(i=>d[i]);
import { fK as hasKey, d as defineComponent, i as createElementBlock, g as openBlock, j as createVNode, k as createBaseVNode, m as unref, p as N8nText, w as withCtx, l as createTextVNode, t as toDisplayString, c as useI18n, by as formatTokenUsageCount, bz as getDefaultExportFromCjs, r as ref, fL as MarkdownIt, x as computed, ay as h, fM as requireVue, fN as sanitizeHtml, fO as sanitizeHtmlExports, _ as _export_sfc, T as useWorkflowsStore, o as onMounted, e6 as jsonParse, fP as base64DecodeUTF8, e as createBlock, n as normalizeClass, br as useNodeHelpers, h as resolveComponent, f as createCommentVNode, bE as withModifiers, bW as useClipboard, a as useToast, fQ as useAIAssistantHelpers, bw as useNodeTypesStore, aA as useNDVStore, a1 as useRootStore, fB as useAssistantStore, J as useUIStore, fR as MAX_DISPLAY_DATA_SIZE, cQ as isCommunityPackageName, bX as resolveDirective, aI as withDirectives, fS as InlineAskAssistantButton, a$ as _sfc_main$b, F as Fragment, G as renderList, fT as NEW_ASSISTANT_SESSION_MODAL, dO as sanitizeHtml$1, aZ as N8nTooltip, a_ as N8nLink, $ as watch, bL as N8nRadioButtons, b1 as createSlots, bH as N8nIcon, a3 as useSourceControlStore, fC as useSchemaPreviewStore, U as useRoute, bJ as toRef, bp as usePinnedData, fU as useNodeType, eR as storeToRefs, fV as TRIMMED_TASK_DATA_CONNECTIONS_KEY, bf as NodeConnectionTypes, fW as executionDataToJson, fX as NODE_TYPES_EXCLUDED_FROM_OUTPUT_NAME_APPEND, fY as CORE_NODES_CATEGORY, fZ as computedAsync, f_ as parseAiContent, cb as ndvEventBus, am as useTelemetry, z as onBeforeUnmount, aR as useStorage, f$ as LOCAL_STORAGE_PIN_DATA_DISCOVERY_NDV_FLAG, g0 as dataPinningEventBus, g1 as LOCAL_STORAGE_PIN_DATA_DISCOVERY_CANVAS_FLAG, g2 as searchInObject, db as getConnectionTypes, g3 as isObject, g4 as MAX_DISPLAY_DATA_SIZE_SCHEMA_VIEW, g5 as HTML_NODE_TYPE, A as renderSlot, ed as N8nCallout, g6 as DATA_PINNING_DOCS_URL, aJ as vShow, dH as Suspense, ec as defineAsyncComponent, bO as normalizeProps, bK as mergeProps, q as N8nButton, g7 as N8nSelect, g8 as _sfc_main$c, g9 as N8nTabs, bP as guardReactiveProps, ga as _sfc_main$d, gb as JsonEditor, fo as InfoTip, gc as DATA_EDITING_DOCS_URL, gd as N8nBlockUi, aw as __vitePreload, dM as getNodeOutputs, ge as getGenericHints, gf as clearJsonKey, gg as TEST_PIN_DATA, aX as useExternalHooks, cn as isPresent, gh as isEmpty, d5 as isEqual } from "./index-C219uDw2.js";
import { F as FileSaver_minExports } from "./FileSaver.min-B7bYplvz.js";
import { u as useExecutionHelpers } from "./useExecutionHelpers-BP0_q8Ec.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    const LazyRunDataTable = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataTable-DNGQZDU6.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const LazyRunDataJson = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJson-CKELOUee.js"), true ? __vite__mapDeps([5,1,2,6,3,7]) : void 0)
    );
    const LazyRunDataSchema = defineAsyncComponent(
      async () => await __vitePreload(() => import("./index-C219uDw2.js").then((n) => n.iB), true ? __vite__mapDeps([1,2]) : void 0)
    );
    ...
    const LazyRunDataAi = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataParsedAiContent-DS2qA7mb.js"), true ? __vite__mapDeps([8,1,2,6,3,9]) : void 0)
    );
    const LazyRunDataSearch = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataSearch-J3D6xD4K.js"), true ? __vite__mapDeps([10,1,2,11]) : void 0)
    );
    const props = __props;
    const emit = __emit;
